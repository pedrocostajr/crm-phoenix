...
import { ChevronLeft, ChevronRight, MoreVertical, Copy, Trash2, Plus, Edit } from 'lucide-react';
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
              <DialogContent>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-2 mt-2">
                      {['#ef4444', '#f59e0b', '#10b981', '#3b82f6', '#6366f1', '#8b5cf6', '#ec4899'].map((color) => (
                        <button
                          key={color}
                          type="button"
                          className={`w-6 h-6 rounded-full border-2 ${editColor === color ? 'border-primary' : 'border-transparent'
                            }`}
                  ...
                  <Button
                    onClick={() => {
                      onUpdateColumn(column.id, editName, editColor);
                      setIsEditOpen(false);
                    }}
                    className="w-full"
                  >
